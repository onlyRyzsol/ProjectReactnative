...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    ...
    >
      <View style={styles.overlay} className="flex-1 justify-center p-10">
...
// Halaman Detail (Slide List Gambar dengan Filter dan Telusuri)
  ...
  return (
    <View style={styles.aboutContainer}>
      ...
      <Text style={styles.aboutText}>
        MountAGoes adalah aplikasi eksplorasi gunung di indonesia. dan
